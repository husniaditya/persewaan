...
// Query to fetch data
$query = "SELECT m.*, d.FOTO, d.KONDISI, REPLACE(d.QTY,'-','') QTY, b.ID_BARANG, b.NAMA_BARANG, k.NAMA_KATEGORI, d.KETERANGAN AS KETERANGAN_PERSEDIAAN, m.KETERANGAN AS KETERANGAN_PEMASUKAN, b.ID_KATEGORI, j.NAMA_PEKERJAAN, j.ID_PEKERJAAN
